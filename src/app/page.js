          ...
          <div className='flex flex-col lg:w-6/12'>
            ...
            <div className='flex lg:flex-row flex-col justify-center w-full lg:justify-start'>
              ...
              <button id='button2' type="button" className=" flex flex-row justify-center items-center px-5 py-4 lg:mt-24 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" style={{color:"#002147"}}>
                  Skip on Tax Savings <img src='images/icons/elements/arrow-right.svg' style={{height:'30px',paddingTop:'3px',marginLeft:'15px'}}/>
              </button>
            </div>
          </div>
          ...
          <div className='flex flex-col'>
            <div className='flex flex-row w-full lg:text-2xl font-normal sm:text-lg mt-5'>
              <div className='flex flex-col justify-center items-center lg:mr-10 mr-5'>
                <img src='images/icons/elements/circle-1.svg' className=' lg:w-8 w-20'/>
            ...
            <div className='flex flex-row w-full lg:text-2xl font-normal sm:text-lg mt-5'>
              <div className='flex flex-col justify-center items-center lg:mr-10 mr-5'>
                <img src='images/icons/elements/circle-2.svg' className=' lg:w-8 w-20'/>
                <div className='flex-1 mt-2 pb-20' style={{width:'2px', height:'100px',background: "#002147"}}>
            ...
            <div className='flex flex-row w-full lg:text-2xl font-normal sm:text-lg mt-5'>
              <div className='flex flex-col justify-center items-center lg:mr-10 mr-5'>
                <img src='images/icons/elements/circle-3.svg' className=' lg:w-8 w-20'/>
                <div className='flex-1 mt-2 pb-20' style={{width:'2px', height:'100px',background: "#002147"}}>
            ...
            <div className='flex flex-row w-full lg:text-2xl font-normal sm:text-lg mt-5'>
              <div className='flex flex-col justify-center items-center lg:mr-10 mr-5'>
                <img src='images/icons/elements/circle-4.svg' className=' lg:w-8 w-20'/>
                <div className='flex-1 mt-2 pb-20' style={{width:'2px', height:'100px',background: "#002147"}}>
          ...
          <div className='flex-1'>
            <div className='flex flex-col justify-between items-start w-full'>
              <div className='flex flex-row p-3'>
                <img className='w-5' src='images/icons/circle-star.svg'/>
              ...
              <div className='flex flex-row  justify-between items-start w-full lg:w-5/12 lg:justify-evenly'>
                ...
                <button id='button3' type="button" className="flex flex-row justify-center items-center  px-5 py-4 mt-24" style={{color:"#FFFFFF"}}>
                  Contact Us <img src='images/icons/elements/arrow-right-white.svg' style={{height:'30px',marginLeft:'15px', color:'white'}}/>
                </button>
              </div>
            </div>
          </div>
      ...
      <section className='flex flex-col lg:flex-row justify-between items-center lg:items-center  w-full h-full bg-white lg:p-20 pt-20 lg:px-96' id='section7'>
          <div className='flex flex-col justify-center items-center w-full lg:m-18 '>
              ...
              <button id='button4' type="button" className="flex flex-row justify-center items-center py-4 mt-14 w-6/12 mb-32 lg:w-2/12" style={{color:"#002147"}}>
                  Contact Us <img src='images/icons/elements/arrow-right.svg' style={{height:'30px',marginLeft:'10px', color:'#002147'}}/>
              </button>
          </div>
